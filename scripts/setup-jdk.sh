...
resolve_jdk_release() {
    ...
    step "Resolving Eclipse Temurin JDK ${JAVA_MAJOR_VERSION} release" >&2
...
select_fastest_jdk_url() {
    ...
    step "Testing Eclipse Temurin download mirrors" >&2
...
verify_jdk_archive() {
    ...
    ok "JDK archive SHA-256 verified"
}
